...
print("*                 Set the RUN_DAY environment variable to run a specific day                *")
print("*********************************************************************************************")
print()
...
func runDay(_ day: Int) -> (() -> Void) {
  switch day {
  case 1: return Day_1().run
  case 2: return Day_2().run
  case 3: return Day_3().run
  case 4: return Day_4().run
  case 5: return Day_5().run
  case 6: return Day_6().run
  case 7: return Day_7().run
  case 8: return Day_8().run
  case 9: return Day_9().run
